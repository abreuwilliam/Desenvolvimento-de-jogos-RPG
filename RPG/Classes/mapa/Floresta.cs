...
namespace RPG.Classes.mapa
{
    ...
    public class MapaDaFloresta
    {
        ...
        public MapaDaFloresta(Personagem heroi)
        {
            this.heroi = heroi;
        }
        ...
        public void Iniciar()
        {
            ...
            // tela de introdução da floresta
            Console.Clear();
            int largura = 80;
            int altura = 16;
            ...
            Console.SetCursorPosition(left + 5, top + 3);
